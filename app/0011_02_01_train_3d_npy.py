...
np.save(npfolder + 'train_3d_centers.npy', train_3d_centers_array)
np.save(npfolder + 'train_3d_dims.npy', train_3d_dims_array)
np.save(npfolder + 'train_3d_head.npy', train_3d_head_array)